...
const trans1 = (x: any, y: any) => `translate3d(${x / 50}px,${y / 50}px,0)`;
const trans2 = (x: any, y: any) => `translate3d(${x / 80}px,${y / 80}px,0)`;
const trans3 = (x: any, y: any) => `translate3d(${x / 30}px,${y / 30}px,0)`;
const trans4 = (x: any, y: any) =>
  `translate3d(${x / 23.25}px,${y / 23.25}px,0)`;
const trans5 = (x: any, y: any) => `translate3d(${x / 17.5}px,${y / 17.5}px,0)`;
const trans6 = (x: any, y: any) => `translate3d(${x / 7.5}px,${y / 7.5}px,0)`;
